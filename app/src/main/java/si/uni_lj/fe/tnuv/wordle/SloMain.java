...
public class SloMain extends AppCompatActivity {
    //array za crke[0] in njihov status/barvo[1]
    char[][][] letterArray = new char [6][5][2];
    int activeRow = 0;
    int activeColumn = 0;
    DatabaseTable db = new DatabaseTable(this);
    static String LANG = "slo";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_slo_main);
        //da se db ustvari vnaprej in ne cakamo
        db.initiateDB();

    }

    public void sloEnterLetter(View view) {
    ...
    public void sloSelectColor(View view) {
